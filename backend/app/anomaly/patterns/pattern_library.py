...
class PatternLibrary:
    ...
    def _register_default_patterns(self):
        ...
        self.register(PatternDefinition(
            ...
            optional_detectors_or_types=["DET-RULE-ENGINE"],
            min_event_count=2,
            what_happened_template="Aarav, Riya and Neha repeatedly appear in the same small Sector 22 area during overlapping windows.",
        ...
        self.register(PatternDefinition(
            ...
            min_event_count=1,
            what_happened_template="Aarav's phone briefly maps to an unexpected IMEI/device/IP before returning to prior identifiers.",
